...
<body>
    ...
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                   ...
                   @if(Auth::check())
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('employeepositions.index') }}">{{ __('employeepositions') }}</a>
                 </li>
              ...
              <li class="nav-item">
                    <a class="nav-link" href="{{ route('entries.index') }}">{{ __('entries') }}</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('outputs.index') }}">{{ __('outputs') }}</a>
         </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('details.index') }}">{{ __('details') }}</a>
    </li>
                    </ul>
                       @endif
